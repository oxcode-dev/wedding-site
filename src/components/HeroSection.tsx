    ...
    return (
        <>
            <div className='h-screen w-full relative'>
                ...
                <div className=" md:hidden relative z-9 h-full w-full">
                    <img className='h-full w-full object-cover' src={hero} />
                </div>

                <motion.div variants={variants} initial='initial' whileInView='animate' className='absolute bottom-10 md:relative z-10 h-full flex flex-col items-center justify-end pb-12 px-4 w-full'>
